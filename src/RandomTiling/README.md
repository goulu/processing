...
- [Sketch sur OpenProcessing #40422](https://openprocessing.org/@Goulu/40422)
...
npm run dev
```
Puis ouvrez [`http://localhost:5173/src/RandomTiling/`](http://localhost:5173/src/RandomTiling/).
